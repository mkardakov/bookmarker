 ...
 */
class File extends \Bookmarker\Db\Entities\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bookmarker\\Db\\Entities\\File' . "\0" . 'id', '' . "\0" . 'Bookmarker\\Db\\Entities\\File' . "\0" . 'ext', '' . "\0" . 'Bookmarker\\Db\\Entities\\File' . "\0" . 'filePath', '' . "\0" . 'Bookmarker\\Db\\Entities\\File' . "\0" . 'mime', '' . "\0" . 'Bookmarker\\Db\\Entities\\File' . "\0" . 'book'];
        }
