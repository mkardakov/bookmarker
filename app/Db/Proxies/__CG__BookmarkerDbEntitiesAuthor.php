 ...
 */
class Author extends \Bookmarker\Db\Entities\Author implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bookmarker\\Db\\Entities\\Author' . "\0" . 'id', '' . "\0" . 'Bookmarker\\Db\\Entities\\Author' . "\0" . 'name', '' . "\0" . 'Bookmarker\\Db\\Entities\\Author' . "\0" . 'surname', '' . "\0" . 'Bookmarker\\Db\\Entities\\Author' . "\0" . 'books'];
        }
