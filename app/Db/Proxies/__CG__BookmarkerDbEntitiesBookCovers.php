 ...
 */
class BookCovers extends \Bookmarker\Db\Entities\BookCovers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bookmarker\\Db\\Entities\\BookCovers' . "\0" . 'id', '' . "\0" . 'Bookmarker\\Db\\Entities\\BookCovers' . "\0" . 'imagePath', '' . "\0" . 'Bookmarker\\Db\\Entities\\BookCovers' . "\0" . 'isMain', '' . "\0" . 'Bookmarker\\Db\\Entities\\BookCovers' . "\0" . 'book'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BookCovers $proxy) {
